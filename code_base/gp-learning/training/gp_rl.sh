...
python gp_rl_main.py --verbose DEBUG --trials 5 --trial-max-iter 20 --num-states 1 --train-data ../data/boom_trial_6_10hz.pkl \
  ...
  --verbose INFO --joint boom --input-lim 1\
  --gpmodel ./results/gp/GPmodel_boom.pkl --plot-mc
# For bucket
python gp_rl_main.py --verbose DEBUG --trials 5 --trial-max-iter 20 --num-states 1 --train-data ../data/bucket_trial_2_10hz.pkl \
  --test-data ../data/bucket_trial_2_10hz.pkl \
  --optimizer NAdam --nondet-init --force-train-gp \
  --verbose INFO --joint bucket --input-lim 1\
  --gpmodel ./results/gp/GPmodel_bucket.pkl --plot-mc
# For telescope
python gp_rl_main.py --verbose DEBUG --trials 5 --trial-max-iter 20 --num-states 1 --train-data ../data/telescope_trial_1_10hz.pkl \
  --test-data ../data/telescope_trial_1_10hz.pkl \
  --optimizer NAdam --nondet-init --force-train-gp \
  --verbose INFO --joint telescope --input-lim 1\
